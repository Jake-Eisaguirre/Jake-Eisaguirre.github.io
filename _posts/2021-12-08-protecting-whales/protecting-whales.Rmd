...
description: |
  The goal of this project is too look at the sperm whale sigthing data and AIS vessel data,to determine the postive and negative impacts of creating a speed reduction zone off the coast of Dominca 
author:
...
grid.plot(facecolor = "none", figsize=(5, 5), linewidth = 1 )
```
...
# Create unary convex hull of whale habitat
```python
