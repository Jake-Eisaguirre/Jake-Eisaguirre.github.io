...
output:
  distill::distill_article:
    ...
    code_folding: hide
---
### Update: I have now completed the list of items mentioned below I wanted to add. I am now attempting to publish this work on an active site in order to help my fellow local so-cal anglers catch more fish. I am now working to incorporate predicted swell models from CDIP buoys.   
...
final_chloro <- clean_chloro %>% 
  ...
  mutate(chlorophyll = log(chlorophyll))
...
app <- leaflet(options = leafletOptions(minZoom = 7.5)) %>%
  ...
  setView(lng = -119.200336, lat = 33.808464, zoom = 7.5) %>% 
